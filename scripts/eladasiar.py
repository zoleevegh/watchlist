...
def detect_session(dt: datetime) -> Optional[str]:
    ...
    Practical rule (as you requested earlier): between AH end and PM start
    (02:00–10:00) still treat it as AH and use the last available AH price
    from the runner snapshot. This covers "aftermarket és premarket előtt".
    """
    ...
    # 02:01–09:59 -> still AH (frozen last AH snapshot)
    if ah_end < minutes < pm_start:
        return "AH"
