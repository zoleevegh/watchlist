...
Verzió: 2.1.4-biblia-yahoo-us-time (visszaállás a stabil 2.1.1-es logikára az #1 riportnál)
"""
...
SCRIPT_VERSION = "2.1.4-biblia-yahoo-us-time"
...
# ---------------------------------------------------------------------------
# 1-es riport: AH + PM (BIBLIA mag, chart alapú)
# ---------------------------------------------------------------------------
